...
const WIZARD_SURFACE =
  'flex-1 min-h-0 sm:flex-none sm:h-[640px] flex flex-col w-full max-w-sm sm:max-w-md mx-auto mt-2 rounded-md border-white/80 shadow-[0_20px_50px_rgba(11,58,26,0.14),0_4px_12px_rgba(11,58,26,0.06)]'
